...
const About: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 text-light-text-primary dark:text-dark-text-primary animate-fade-in">
      <h2 className="text-3xl font-extrabold text-center mb-6">About the Domain Research Dashboard</h2>
      
      <div className="bg-light-card dark:bg-dark-card p-8 rounded-lg shadow-lg dark:border dark:border-dark-border space-y-6">
        <section>
          <h3 className="text-2xl font-bold text-primary mb-3">What is this Tool?</h3>
        ...
        <section>
          <h3 className="text-2xl font-bold text-primary mb-3">Key Features</h3>
